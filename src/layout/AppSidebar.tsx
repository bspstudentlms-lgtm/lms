...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      const parsed = enrolled ? enrolled.split(',').map(course => course.trim()) : [];
...
//alert('local'+roleFromStorage);
//alert(role);

  const navItems: NavItem[] = [
  // Dashboard for student, sos
  //  ...((role === "sos")
  //   ? [
  //       {
  //         icon: <GridIcon />,
  ...
  ...(role === "student"
    ? [
        ...
        //   path: "/coursedetails",
        //   subItems: courses
        //     .filter(course => enrolledCourses.includes(course.shortname))
        //     .map(course => ({
        //       name: course.title,
        //       path: `/coursedetails/${course.id}`,
        //       pro: course.pro,
        //     })),
        // },
        {
  ...
  // ];
  useEffect(() => {
    if (pathname === "/coursedetails") {
      setIsExpanded(false); // ✅ Collapse on /coursedetails
    }
          ...
          {isExpanded || isHovered || isMobileOpen ? (
            ...
            {!isMobileOpen ? 
              ...
              <Image
                ...
                src="https://www.backstagepass.co.in/logo-16c7e4db.webp"
                alt="Logo"
                width={250}
                height={40}
              /></> : null
            ...
            <Image
              src="/images/logo/bsp_logo_newupdated.png"
              alt="Logo"
              width={32}
              height={32}
            />
