...
export default function SignInForm() {
  ...
  return (
    <div className="flex flex-col flex-1 lg:w-1/2 w-full">
      ...
      <div className="flex flex-col justify-start sm:justify-center flex-1 w-full max-w-md mx-auto">
        <div>
          <div className="mb-5 sm:mb-8">
            <h1 className="mb-2 font-semibold text-gray-800 text-lg sm:text-title-md dark:text-white/90">
              Sign In
            </h1>
            ...
            <form onSubmit={handleSignIn}>
              <div className="space-y-4 sm:space-y-6">
                <div>
                  ...
                  <Input placeholder="info@gmail.com" type="email" id="email" value={email}
