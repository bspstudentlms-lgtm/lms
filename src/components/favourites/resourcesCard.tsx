      ...
      try {
        ...
        console.log('fetchdata'+ data);
         if (Array.isArray(data) && data.length > 0) {
          setDocument(data[0]); // Just showing the first document
        }
...
>
  <path
    fillRule="evenodd"
    clipRule="evenodd"
    d="M9 3.75C4.875 3.75 1.515 6.525 0.75 9C1.515 11.475 4.875 14.25 9 14.25C13.125 14.25 16.485 11.475 17.25 9C16.485 6.525 13.125 3.75 9 3.75ZM2.27175 9C3.1575 6.915 5.745 5.25 9 5.25C12.255 5.25 14.8425 6.915 15.7283 9C14.8425 11.085 12.255 12.75 9 12.75C5.745 12.75 3.1575 11.085 2.27175 9ZM9 6.75C7.48125 6.75 6.25 7.98125 6.25 9.5C6.25 11.0188 7.48125 12.25 9 12.25C10.5188 12.25 11.75 11.0188 11.75 9.5C11.75 7.98125 10.5188 6.75 9 6.75ZM9 10.75C8.30964 10.75 7.75 10.1904 7.75 9.5C7.75 8.80964 8.30964 8.25 9 8.25C9.69036 8.25 10.25 8.80964 10.25 9.5C10.25 10.1904 9.69036 10.75 9 10.75Z"
    fill=""
  />
</svg>
